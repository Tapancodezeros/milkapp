...
import { LayoutDashboard, Users, Briefcase, CreditCard, Calendar, LogOut } from 'lucide-react';
...
const AdminSidebar = ({ activeTab, setActiveTab, isSidebarOpen, isDarkMode, handleLogout }) => {
    return (
        <aside
